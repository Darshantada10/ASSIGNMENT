...
} elseif ($_instance->childHasBeenRendered('b2b136V')) {
    $componentId = $_instance->getRenderedChildComponentId('b2b136V');
    $componentTag = $_instance->getRenderedChildComponentTagName('b2b136V');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('b2b136V');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('b2b136V', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\TOPS-ASSIGNMENT\thunder_restaurant\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>