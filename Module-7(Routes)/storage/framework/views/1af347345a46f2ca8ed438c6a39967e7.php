...
} elseif ($_instance->childHasBeenRendered('959DUGQ')) {
    $componentId = $_instance->getRenderedChildComponentId('959DUGQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('959DUGQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('959DUGQ');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('959DUGQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('ZktaHZI')) {
    $componentId = $_instance->getRenderedChildComponentId('ZktaHZI');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZktaHZI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZktaHZI');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('ZktaHZI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\xampp\htdocs\TOPS-ASSIGNMENT\thunder_restaurant\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>